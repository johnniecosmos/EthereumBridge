...
from src.signer.eth.historical import EtherSigner
from src.signer.secret20.signer import Secret20Signer, MultiSig
...
if __name__ == "__main__":
    ...
    scrt_signer_1 = Secret20Signer(web3_provider, singer_acc_1, erc20_contract, config)
    scrt_signer_2 = Secret20Signer(web3_provider, singer_acc_2, erc20_contract, config)
